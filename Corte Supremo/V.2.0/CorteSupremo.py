...
def corteSupremo ():
    ...
    while (porcentaje < 1):
        ...
        """else:
            ...
            if ganancia(parteIzquierda, f1) == ganancia(parteDerecha, f1) and ganancia(parteIzquierda, f1) >= gananciaMaxF1:
            ...
            elif ganancia(parteIzquierda, f1) == ganancia(parteDerecha, f2):
